...
par(mfcol=c(2,2))
##plot the grafic 1
plot(data$Time, data$Global_active_power, type="l", col="black", xlab="", ylab="Global Active Power", main="")
##plot the grafic 2
...
##plot the grafic 3
plot(data$Time, data$Voltage, type="l", col="black", xlab="datetime", ylab="Voltage", main="")
##plot the grafic 4
plot(data$Time, data$Global_reactive_power, type="l", col="black", xlab="datetime", ylab="Global_reactive_power", main="")
##close the file
dev.off()